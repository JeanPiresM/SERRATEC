...
let entradaSalario: number;

entradaSalario = parseFloat(prompt("Declare o salario: "));

let descontoValeTransporte = entradaSalario * 0.06;

let descontoInss = entradaSalario * 0.08;

let sobraSalario = entradaSalario - descontoValeTransporte - descontoInss;



console.log(`O salario declarado é ${entradaSalario} reais`);

console.log(`O desconto do vale transporte será ${descontoValeTransporte} reais`);

console.log(`O desconto do INSS será ${descontoInss} reais`);

console.log(`A sobra do seu salario será ${sobraSalario} reais`);
