...
function criarMatriz() {
    ...
    for (var linha = 0; linha < 4; linha++) {
        ...
        for (var coluna = 0; coluna < 4; coluna++) {
            matriz[linha][coluna] = parseInt(prompt("Insira o valor para Matriz[".concat(linha + 1, "][").concat(coluna + 1, "]")));
        }
    }
    return matriz;
}
function imprimirMatriz(matriz) {
    for (var linha = 0; linha < matriz.length; linha++) {
        for (var coluna = 0; coluna < matriz[linha].length; coluna++) {
            console.log("Matriz[".concat(linha + 1, "][").concat(coluna + 1, "] = ").concat(matriz[linha][coluna]));
        }
    }
}
...
function somarElementosTerceiraLinha(matriz) {
    var soma = 0;
    for (var coluna = 0; coluna < matriz[2].length; coluna++) {
        soma += matriz[2][coluna];
    }
    return soma;
}
function somarElementosDiagonalPrincipal(matriz) {
    var soma = 0;
    for (var linha = 0; linha < matriz.length; linha++) {
...
function somarElementosIndiceParSegundaLinha(matriz) {
    var soma = 0;
    for (var coluna = 0; coluna < matriz[1].length; coluna % 2 == 0) {
...
console.log("A soma dos quadrados da primeira coluna:", somarQuadradosPrimeiraColuna(matriz));
console.log("A soma dos elementos da terceira linha:", somarElementosTerceiraLinha(matriz));
console.log("A soma dos elementos da diagonal principal \u00E9:", somarElementosDiagonalPrincipal(matriz));
console.log("A soma dos elementos de indice par da segunda linha \u00E9:", somarElementosIndiceParSegundaLinha(matriz));
