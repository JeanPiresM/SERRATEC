...
var somaNumeros = 0;
var mediaNumeros = 0;
for (var indice_1 = 0; indice_1 < 10; indice_1++) {
    var entradaNumerosMedia = prompt("Digite a sequencia de numeros para media");
    if (entradaNumerosMedia !== null) {
        numerosMedia[indice_1] = parseFloat(entradaNumerosMedia);
...
console.log("A m\u00E9dia dos n\u00FAmeros informados \u00E9: ".concat(mediaNumeros));
